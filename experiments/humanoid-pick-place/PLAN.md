...
- [x] Execute [AGY task 003](../../coordination/agy/tasks/003-p5-preparation.md): prepare revised passive P5 protocol and runner using existing development inputs; no held-out execution.
