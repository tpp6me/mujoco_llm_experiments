...
- [x] Implement and review [AGY task 005](../../coordination/agy/tasks/005-visual-provider-adapter.md): image-capable Responses adapter using injected transport and an unfrozen first visual pilot draft ([protocols/V1_PROPOSAL.md](protocols/V1_PROPOSAL.md)); no paid execution.
