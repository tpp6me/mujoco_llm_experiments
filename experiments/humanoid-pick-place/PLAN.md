...
- [x] Execute [AGY task 004](../../coordination/agy/tasks/004-visual-policy-scaffold.md): implemented offline RGB-to-action runner with injected stub, public allowlist, and input-isolation tests; no live model calls; [runner documentation](VISUAL_POLICY_RUNNER.md).
