...
The [experimental carried-center candidate](CARRIED_POSE.md) has now been tested
...
[AGY task 001](../../coordination/agy/reviews/001-acceptance.md) is integrated as
development-only reacquisition: 17/20 targets accepted, 16 within 20 mm, with one
21.94 mm false acceptance. Additional-view evidence is assigned in
[task 002](../../coordination/agy/tasks/002-reacquisition-evidence.md); fresh P5
validation and control integration remain pending.
