...
| [002](tasks/002-reacquisition-evidence.md) | [Changes requested: cache integrity](reviews/002-review-r2.md) | `agy/002-reacquisition-evidence` | Test additional fresh-view evidence on development trajectories; no fresh P5 run |
