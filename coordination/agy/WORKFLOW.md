...
| [005](tasks/005-visual-provider-adapter.md) | Ready | `agy/005-visual-provider-adapter` | Responses image adapter with injected offline transport and unfrozen pilot draft |
