...
Status: accepted for development-only integration; see `coordination/agy/reviews/002-acceptance.md`
...
- **Remedy:**
  - In `humanoid_sim/temporal_reacquisition_evaluation.py`:
    ...
    - Production manifest constants and fingerprinting:
      ...
      - `AUGMENTED_CAMERA_CONFIG = {"camera_name": "fixed", "lookat": [0.24, -0.24, 0.8], "distance": 1.35, "azimuth": 90.0, "elevation": -65.0, "width": 960, "height": 720}`
