...
Status: ready for delegation after Task 009 acceptance; no live experiment authorized.
...
- [ ] Add opt-in `c3` beside unchanged/default `c1` and existing `c2`. Preserve
...
- [ ] Define the strict response schema and validation. Reject missing/extra fields,
...
- [ ] Retain assessments with image identity, time, full prompt hash, schema hash,
...
- [ ] Preserve 20 decisions, simulated t=25 seconds, 120 seconds per invocation,
...
- [ ] Add meaningful offline tests: exact C1/C2 prompt preservation, exact proposed
...
- [ ] Generate an offline preflight using committed public observations and stubbed
...
- [ ] Run affected tests once after fixes, preserve their logs, update the living
...
- [ ] Commit/push only the task branch and return the exact handoff tip. Stop for
